          ...
          <div class="cft-filter-sort">
            <div v-for="(sort, idx) in sortList" :key="sort.sortBy">
              <div class="mr-3" :key="idx">
                ...
                <button v-if="sortOptions.length">
...
export default class Tasklist extends Vue {
  ...
  checkPropsIsPassedAndSetValue() {
    ...
    this.userName = !this.userName
      ? decodeToken && decodeToken["preferred_username"]
      : this.userName;
    ...
    this.formIOUserRoles = !this.formIOUserRoles
      ? decodeToken["resource_access"]["forms-flow-web"]["roles"]
